...
typedef struct LLVMJitContext
{
	...
	LLVMModuleRef module_jit;   		/*#RAIN*/
	LLVMModuleRef module_inline;		/*#RAIN*/
	LLVMModuleRef module_opt;			/*#RAIN*/
...
extern LLVMModuleRef llvm_mutable_module(LLVMJitContext *context, const char *ModuleID);
extern LLVMModuleRef llvm_mutable_module_select(LLVMJitContext *context, ModuleType type);
...
extern LLVMValueRef slot_compile_deform(struct LLVMJitContext *context, TupleDesc desc,
										const struct TupleTableSlotOps *ops, int natts, ModuleType type);
